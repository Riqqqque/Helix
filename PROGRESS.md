...
- Modpack install is a server-safe subset for Modrinth `.mrpack` and CurseForge
  ...
  supplies one in Settings → Catalogs. CurseForge also needs this host on a
  normal ISP IP; VPS and VPN exits are often blocked.
