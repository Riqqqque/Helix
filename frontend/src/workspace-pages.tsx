...
export function HostPage({ data, csrfToken, canManageDocker, canPower = false, onSessionExpired }: { data: DashboardData; csrfToken: string; canManageDocker: boolean; canPower?: boolean; onSessionExpired: () => void }) {
  const overview = data.overview.data;
  const inventory = data.inventory.data;
  return (
    <div class="page page--host">
      <PageHead title="Host" detail="Linux updates, services, and the processes using this machine." /><InlineError message={data.overview.error ?? data.inventory.error} />
      ...
      <HostUpdatesRoute csrfToken={csrfToken} canPower={canPower} onSessionExpired={onSessionExpired} />
