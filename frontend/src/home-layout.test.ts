...
describe('home layout', () => {
  ...
  it('keeps weather configuration bounded and defaults safely', () => {
    ...
    expect(normalizeHomeWidgets([{ id: 'live', kind: 'graphs', size: 'wide', title: 'Live graphs' }, { id: 'boxes', kind: 'docker', size: 'wide', title: 'Docker' }, { id: 'ext', kind: 'strand', size: 'wide', title: 'System Health', url: 'b893d568-327d-4b6e-b0b6-0b7a58e0c852' }, { id: 'map', kind: 'globe', size: 'wide', title: 'Globe' }]).map((widget) => widget.kind)).toEqual(['graphs', 'docker', 'strand', 'globe']);
  });
