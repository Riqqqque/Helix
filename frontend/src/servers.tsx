...
import { ModpackChangelogButton } from "./modpack-changelog";
import {
...
import { ServerRestartSchedulePanel } from "./server-restart-schedule";
  ...
  return (
    <div class="page page--server-detail">
      ...
      {detail.modpack !== null && (
        ...
        >
          ...
          <div class="modpack-update-actions">
            {modpackUpdateCandidate !== null && <ModpackChangelogButton key={`${detail.modpack.provider}:${detail.modpack.projectId}:${modpackUpdateCandidate.id}`} pack={detail.modpack} version={modpackUpdateCandidate} csrfToken={csrfToken} onSessionExpired={onSessionExpired} />}
            {modpackUpdateCandidate !== null && (
              <button
                class="button button--primary"
                type="button"
      ...
      <div class="server-tab-content">
        {tab === "overview" && (
          <>
            <ServerRestartSchedulePanel id={detail.id} name={detail.name} schedule={detail.restartSchedule} csrfToken={csrfToken} canManage={canManageServers} onSaved={refresh} onSessionExpired={onSessionExpired} />
...
function ImportedServerPage({
  ...
  return (
    <div class="page page--server-detail">
      ...
      <ServerRestartSchedulePanel id={server.id} name={server.name} schedule={undefined} csrfToken={csrfToken} canManage={canManageServers} onSaved={() => void onRefresh()} onSessionExpired={onSessionExpired} />
      <div class="server-overview-grid">
        <section class="surface server-health">
          <div class="section-title">
            <div>
