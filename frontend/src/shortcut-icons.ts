...
const NAME_ALIASES: ReadonlyArray<readonly [RegExp, string]> = [
  ...
  [/\bsatisfactory\b/u, 'satisfactory'],
  [/\bproject[\s-]?zomboid\b/u, 'project-zomboid'],
  [/\b7[\s-]?days[\s-]?to[\s-]?die\b|\b7dtd\b/u, '7-days-to-die'],
  [/\brust\b/u, 'rust'],
  [/\bsons[\s-]?of[\s-]?the[\s-]?forest\b/u, 'sons-of-the-forest'],
  [/\bfactorio\b/u, 'factorio'],
  [/\bdon.?t[\s-]?starve[\s-]?together\b|\bdonotstarve\b/u, 'dont-starve-together'],
  [/\bvintage[\s-]?story\b|\bvintagestory\b/u, 'vintage-story'],
  [/\bollama\b/u, 'ollama'],
