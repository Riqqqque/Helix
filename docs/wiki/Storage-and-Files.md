...
direct folder contents. They are sortable and paginated. A file row can open its
containing folder or move that exact file to recoverable trash after a red
confirmation.
